...
app.config['LIPS_FOLDER'] = 'app/static/LipsImage/'
...
remove_file('app/static/uploads')
remove_file('app/static/LipsImage')
...
def upload_files():
    ...
    if filename != '' and hex_value != '':
        ...
        image_path = set_imagepath('app/static/uploads')
        print(image_path);
        remove_file('app/static/LipsImage')
